...
public class CargadeDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.guardar(nombreMasco,razaMasco,color,observaciones,alergico,atencionEsp,nombreDuenio,
                celDuenio);
        
        
        //Va a crear un panel de opciones
       // JOptionPane optionPane = JOptionPane("Se guardo con exito!!!");
